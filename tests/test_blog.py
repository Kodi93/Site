...
class BlogTests(unittest.TestCase):
    ...
    def test_generate_blog_post_builds_rich_html(self) -> None:
        ...
        self.assertIn("<h2>Overview</h2>", blog.html)
        self.assertIn("<h3>Highlights</h3>", blog.html)
        self.assertIn("<h3>Pros</h3>", blog.html)
        self.assertIn("<h3>Cons</h3>", blog.html)
        self.assertIn("<h3>Usage tips</h3>", blog.html)
        self.assertIn("Good for:", blog.html)
        self.assertNotIn("campaign-playbook", blog.html)
        self.assertNotIn("Launch checklist", blog.html)
        self.assertNotIn("cta-button", blog.html)
        self.assertNotIn("Review the listing on Amazon", blog.html)
